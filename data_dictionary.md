...
| Table | Grain | Purpose |
|---|---|---|
| entities.csv | finance operations workflow | Segment, owner, and metadata |
| daily_metrics.csv | finance operations workflow x day | Performance, value, quality, and risk metrics |
